...
class OnBoardScreen_Page1 extends StatefulWidget {
  @override
  _OnBoardScreen_Page1State createState() => _OnBoardScreen_Page1State();
}

class _OnBoardScreen_Page1State extends State<OnBoardScreen_Page1> {
  @override
